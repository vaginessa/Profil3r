from app.modules.programming.github import Github
from app.modules.programming.pastebin import Pastebin
from app.modules.programming.replit import Replit
